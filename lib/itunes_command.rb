...
module Strongspace::Command
  class Itunes < Base
    ...
    def backup
      ...
      rsync_command = "#{rsync_binary} -e 'ssh -oServerAliveInterval=3 -oServerAliveCountMax=1' --delete --exclude 'Album Artwork' -avr #{@local_library_path}/ #{strongspace.username}@#{strongspace.username}.strongspace.com:#{@strongspace_path}/"
